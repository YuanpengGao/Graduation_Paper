...
后续章节为原作者对模板的使用说明，由于本人修改过模板，部分细节已不再相同。为尊重原作者的劳动成果，我没有大幅修改后续章节\footnote{我对后续章节的修改仅限于将 \texttt{\string\citet} 替换为 \texttt{\string\cite} 以消除编译错误。}，阅读时请对照 \texttt{README.md} 中的修改内容说明。
